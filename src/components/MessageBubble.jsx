...
function MessageBubble({ message }) {
    ...
    const isAssistantWithPdf = message.type === 'assistant_with_pdf';
                ...
                <div className={`px-4 py-3 rounded-2xl ${
                    ...
                    {isAssistantWithPdf && (
                        <div>
                            ...
                            <PDFViewer file={message.pdf} />
                        </div>
                    )}
                    {isPdf && <PDFViewer file={message.content} />}
                    {!isPdf && !isAssistantWithPdf && (
                        <p className="text-md leading-relaxed whitespace-pre-wrap">
                            {message.content}
                        </p>
                    )}
                    {!isUser && 
                        <div className="flex mt-2 text-[#D0D0D0]">
                            <div className="flex mr-2 hover:text-black cursor-pointer">
                            ...
                            <div className="flex mr-2 hover:text-black cursor-pointer">
                                ...
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-sm"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.29289 9.29289C5.68342 8.90237 6.31658 8.90237 6.70711 9.29289L12 14.5858L17.2929 9.29289C17.6834 8.90237 18.3166 8.90237 18.7071 9.29289C19.0976 9.68342 19.0976 10.3166 18.7071 10.7071L12.7071 16.7071C12.5196 16.8946 12.2652 17 12 17C11.7348 17 11.4804 16.8946 11.2929 16.7071L5.29289 10.7071C4.90237 10.3166 4.90237 9.68342 5.29289 9.29289Z" fill="currentColor"></path></svg>
                            </div>
                        </div>
                    }
                </div>
