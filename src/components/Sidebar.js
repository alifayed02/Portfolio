    ...
    return (
        <div className="bg-[#DBDBDB] h-screen w-1/4 min-w-[300px] flex flex-col">
            ...
            <div className="flex">
                ...
                <div className="mt-5 ml-5 text-[#5E5E5E] items-center">
            ...
            {/* Options */}
            <div className="flex mt-5 bg-[#D0D0D0] ml-5 mr-5 rounded-xl">
            ...
            <div className="flex mt-5 ml-5 mr-5 rounded-md">
                <div className="flex pl-3 pt-3 pb-3 items-center">
            ...
            <div className="flex flex-col h-full overflow-y-auto">
                ...
                <div className="flex pt-2 pb-2 ml-5 mr-5 mt-auto mb-5 hover:bg-[#D0D0D0] rounded-xl">
