...
function Sidebar() {
    ...
    return (
        <div className="bg-[#DBDBDB] h-screen w-1/4 min-w-[300px] flex flex-col">
            ...
            <div className="flex">
                <div 
                    className="flex mt-5 ml-5 items-center"
                ...
                <div className="mt-5 ml-16 text-[#5E5E5E] items-center">
                ...
                <div className="mt-5 ml-5 text-[#5E5E5E] tems-center">
